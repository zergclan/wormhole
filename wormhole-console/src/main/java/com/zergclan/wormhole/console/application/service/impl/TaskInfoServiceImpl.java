...
/**
 * Implemented Service of {@link TaskInfoService}.
 */
...
public class TaskInfoServiceImpl implements TaskInfoService {
    ...
    @Override
    public void add(final TaskInfo taskInfo) {
        taskInfoRepository.add(taskInfo);
    }
    
    @Override
    public boolean editById(final TaskInfo taskInfo) {
        return taskInfoRepository.edit(taskInfo.getId(), taskInfo);
    }
    
    @Override
    public boolean removeById(final Integer id) {
        return taskInfoRepository.remove(id);
    }
    
    @Override
    public TaskInfo getById(final Integer id) {
        return taskInfoRepository.get(id);
    }
    
    @Override
    public Collection<TaskInfo> listAll() {
        return taskInfoRepository.listAll();
    }
    
    @Override
    public PageData<TaskInfo> listByPage(final PageQuery<TaskInfo> pageQuery) {
        return taskInfoRepository.listByPage(pageQuery);
    }
}
