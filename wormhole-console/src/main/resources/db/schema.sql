...
CREATE TABLE plan_info(
    ...
    `execution_corn` VARCHAR(16) NOT NULL COMMENT '执行corn表达式',
...
CREATE TABLE task_info(
    ...
    `source_datasource_id` INT(11) NOT NULL COMMENT '源数据源ID',
    `target_datasource_id` INT(11) NOT NULL COMMENT '目标数据源ID',
    `is_enable` tinyint(4) NOT NULL COMMENT '0关闭，1开启',
    `is_execute` tinyint(4) NOT NULL COMMENT '0未执行，1执行中',
