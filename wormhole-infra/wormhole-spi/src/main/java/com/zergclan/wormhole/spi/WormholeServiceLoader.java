...
import com.zergclan.wormhole.spi.annotation.SingletonSPI;
...
/**
 * Service loader in Wormhole.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class WormholeServiceLoader {
    ...
    private static <T> Collection<T> createNewServiceInstances(final Class<T> serviceInterface) {
        ...
        for (Object each : services) {
            result.add(createInstance(each));
        }
        return result;
    }
    ...
    private static <T> T createInstance(final Object service) {
        return (T) service.getClass().getDeclaredConstructor().newInstance();
    }
