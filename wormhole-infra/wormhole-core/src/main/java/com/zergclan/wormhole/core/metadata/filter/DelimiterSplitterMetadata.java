...
public final class DelimiterSplitterMetadata implements FilterMetadata {
     ...
     */
    public static DelimiterSplitterMetadata builder(final String taskIdentifier, final int order, final Properties props, final Collection<String> targetNames, final String sourceName) {
        return null;
    }
}
