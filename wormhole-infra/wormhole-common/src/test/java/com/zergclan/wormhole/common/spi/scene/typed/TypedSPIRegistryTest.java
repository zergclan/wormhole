...
package com.zergclan.wormhole.common.spi.scene.typed;
...
import com.zergclan.wormhole.common.spi.scene.typed.fixture.TypedSPIFixture;
import com.zergclan.wormhole.common.spi.scene.typed.fixture.TypedSPIFixtureProperties;
import com.zergclan.wormhole.common.spi.scene.typed.fixture.TypedSPIFixturePropertiesImpl;
...
public final class TypedSPIRegistryTest {
    ...
    public void assertGetRegisteredService() {
        ...
        assertEquals("No service provider of SPI [com.zergclan.wormhole.common.spi.scene.typed.fixture.TypedSPIFixture], with type [FIXTURE_TYPE_ERROR]", exception.getMessage());
    }
