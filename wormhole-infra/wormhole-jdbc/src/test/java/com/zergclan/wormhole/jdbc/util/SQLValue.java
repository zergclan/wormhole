...
//            case "decimal":
    ...
    public String toString() {
        ...
        if (value instanceof Date) {
            return formatString(new SimpleDateFormat("yyyy-MM-dd").format(value));
        }
        if (value instanceof Time) {
            return formatString(new SimpleDateFormat("HH:mm:ss").format(value));
        }
        if (value instanceof Timestamp) {
            return formatString(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(value));
        }
