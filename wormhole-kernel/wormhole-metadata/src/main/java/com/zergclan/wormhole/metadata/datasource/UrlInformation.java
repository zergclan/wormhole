...
package com.zergclan.wormhole.metadata.datasource;

import com.zergclan.wormhole.common.util.StringUtil;
import com.zergclan.wormhole.metadata.exception.UnrecognizedDatabaseURLException;
...
//        String url = "jdbc:mysql://127.0.0.1:3306/demo_ds?serverTimezone=UTC&useSSL=false&sessionVariables=group_concat_max_len=204800,SQL_SAFE_UPDATES=0";
//        UrlInformation urlInformation = UrlInformation.build(url);
//        System.out.println(urlInformation.getHost());
//        System.out.println(urlInformation.getPort());
//        System.out.println(urlInformation.getCatalog());
//        System.out.println(urlInformation.getQueryProperties());
//    }
}
